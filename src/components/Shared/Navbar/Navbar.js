...
const Navbar = () => {
    ...
    return (
        <nav style={{backgroundColor: '#000000'}} className="navbar navbar-expand-lg customize-navbar sticky-top">
            <div className="container">

                <NavLink style={{color: '#ffffff'}} className="navbar-brand" to="/">
                    <img src={logo} width={50} className='img-fluid' alt="logo" />SOFTEC E-Commerce
                </NavLink>
